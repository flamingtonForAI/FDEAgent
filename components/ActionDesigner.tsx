    ...
    <div className="h-full bg-[#0a0a0a] flex">
      ...
      <div className="w-64 border-r border-white/[0.06] flex flex-col">
        ...
        <div className="p-4 border-b border-white/[0.06]">
          <label className="text-[10px] text-gray-500 block mb-2">{t.selectObject}</label>
          <select
        ...
        <div className="flex-1 overflow-y-auto p-4">
          <label className="text-[10px] text-gray-500 block mb-2">{t.selectAction}</label>
          {selectedObject && selectedObject.actions.length > 0 ? (
            ...
            <p className="text-gray-600 text-sm">{t.noActions}</p>
          )}
        </div>
      </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      ...
                      {(editingAction.logicLayer?.preconditions || []).length === 0 && (
                        <p className="text-xs text-gray-600">{lang === 'cn' ? '暂无前置条件' : 'No preconditions yet'}</p>
                      )}
                    </div>
                  </div>
